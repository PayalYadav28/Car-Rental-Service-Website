          ...
          <div class="row align-items-end ">
            <div class="col-lg-5">
              ...
              <div class="intro">
                ...
                <div class="custom-breadcrumbs"><a href="index">Home</a> <span class="mx-2">/</span> <strong>Login</strong></div>
              </div>
            ...
            <form action="createUser" method="post" >
              ...
              <div class="form-group row">
                <div class="col-md-6 mr-auto">
                  <input type="submit" id="login"class="btn btn-block btn-primary text-white py-3 px-5" value="Register">
                </div>
              </div>
              <div class="text-center dont-have" id="dont">Don't have an account yet?  <a href="login"id="logina">Login</a></div>
            </form>
          </div>
