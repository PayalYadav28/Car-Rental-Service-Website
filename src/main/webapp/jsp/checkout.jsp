...
<div class='checkout'>
  <div class='order'>
    ...
    <%Reservation res=(Reservation)session.getAttribute("final"); %>
    <img style="height: 214px;width: 244px;margin-top: 26px;" src="<%=res.getImage()%>">
      
    
    <h5 class='total'>Total</h5><h1>Rs. <%=res.getPrice() %></h1>
  </div>
  <h2>Payment</h2>
  <div id='payment' class='payment'>
    ...
    <div class='card-form'>
      ...
      <button id="myButton" class='button-cta' title='Confirm your purchase'><span><a href="sendemail?email=<%=u.getEmail() %>" >RENT CAR</a></span></button>
    </div>
  </div>
...
<div id="myPopup" class="popup">
  ...
  <g>	<path d="M155.139,0C69.598,0,0,69.598,0,155.139c0,85.547,69.598,155.139,155.139,155.139   c85.547,0,155.139-69.592,155.139-155.139C310.277,69.598,240.686,0,155.139,0z M144.177,196.567L90.571,142.96l8.437-8.437   l45.169,45.169l81.34-81.34l8.437,8.437L144.177,196.567z" fill="#3ac569"/>
    ...
    <h1 style="color:green;margin-left: 24px">
      Hello, <%=u.getFname()%> Your Car Has been Booked
    </h1>
